...
public class TestJavaNio {
    ...
    public static String pathname = "D:\\FileTest\\read.txt";
    public static String filename = "D:\\FileTest\\write.txt";
    ...
    public static void writeNIO() {
        ...
        try {
            ...
            ByteBuffer src = null;
            for (int i = 0; i < 1000_10000; i++) {
                 src = Charset.forName("utf8").encode(i+",17826800154"+System.lineSeparator());
            }
